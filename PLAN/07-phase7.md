...
- [ ] Implement basic comparison for resource address and actions if practical. (Deferred: v0 uses stub behavior)
- [ ] Support forbidden actions such as delete. (Deferred: v0 uses stub behavior)
